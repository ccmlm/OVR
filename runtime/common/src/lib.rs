...
pub mod precompile;
pub use precompile::{AllPrecompiles, MultiCurrencyPrecompile, ScheduleCallPrecompile, StateRentPrecompile};
...
mod tests {
    ...
    fn is_core_precompile_works() {
        ...
        assert!(!is_core_precompile(H160::from_low_u64_be(PRECOMPILE_ADDRESS_START - 1)));
